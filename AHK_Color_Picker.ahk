...
; AHK_Color_Picker (ComDlg32_ChooseColor)
...
Gui,Show,w100 h100,Color Test
return

choose:
	cc := dlg_color(cc,hwnd,defColor,"basic") ; hwnd and defColor are optional
...
Dlg_Color(Color := 0, hwnd := 0, ByRef custColorObj := "",disp:="full") {
